...
{
    CConfigFileData *m_data = new CConfigFileData();
    void *src_data_ptr;

    m_data->Set(group, name, "");
    src_data_ptr = bsearch(&m_data, this->p_conf_data, this->p_conf_data_counter, 4, CConfigFile::Comp);
